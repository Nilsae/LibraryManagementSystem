...
#include "../Login_MY_FINAL/window_registernewaccount.h"
...
QT_MOC_LITERAL(3, 58, 28), // "on_radioButton_Admin_clicked"
QT_MOC_LITERAL(4, 87, 49), // "on_lineEdit_ConfirmPassword_c..."
QT_MOC_LITERAL(5, 137, 4), // "arg1"
QT_MOC_LITERAL(6, 142, 4) // "arg2"

    },
    "Window_RegisterNewAccount\0"
    "on_pushButton_Register_clicked\0\0"
    "on_radioButton_Admin_clicked\0"
    "on_lineEdit_ConfirmPassword_cursorPositionChanged\0"
    "arg1\0arg2"
};
...
//        case 1: _t->on_radioButton_Admin_clicked(); break;
        case 2: _t->on_lineEdit_ConfirmPassword_cursorPositionChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
